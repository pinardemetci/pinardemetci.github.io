        ...
        function(b, c, a) {
            (function() {
                ...
                d.setCookie = function(l, i, h, k, g, j) {
                    ...
                    document.cookie = l + "=" + encodeURIComponent(i) + (h ? ";expires=" + f.toGMTString() : "") + ";path=" + (k || "/") + (g ? ";domain=" + g : "") + (j ? ";secure" : "")
                }
            }())
        }, {}
    ],
        ...
        function(b, c, a) {
            (function() {
                ...
                j.detectSignature = function(t) {
                    var r = [f.userAgent, [k.height, k.width, k.colorDepth].join("x"), (new Date()).getTimezoneOffset(), j.hasSessionStorage(), j.hasLocalStorage()];
                    var o = [];
                    if (f.plugins) {
                        for (var s = 0; s < f.plugins.length; s++) {
                            ...
                            o.push([f.plugins[s].name + "::" + f.plugins[s].description, p.join("~")])
                        }
                    }
                ...
                j.detectBrowserFeatures = function(p) {
                    ...
                    if (typeof f.javaEnabled !== "unknown" && !n.isUndefined(f.javaEnabled) && f.javaEnabled()) {
                        q.java = "1"
                    }
            ...
            (function() {
                ...
                d.fixupUrl = function(j, g, h) {
                    ...
                    if (j === "translate.googleusercontent.com") {
                        ...
                        if (j === "cc.bingj.com" || j === "webcache.googleusercontent.com" || j.slice(0, 5) === "74.6.") {
    ...
    12: [
        function(b, c, a) {
            (function() {
                ...
                var u = r.toString;
                var g = RegExp("^" + String(u).replace(/[.*+?^${}()|[\]\\]/g, "\\$&").replace(/toString| for [^\]]+/g, ".*?") + "$");
                ...
                var p = h || function(z) {
                    return z && typeof z == "object" && typeof z.length == "number" && u.call(z) == w || false
                };
                ...
                function q(z) {
                    return typeof z == "string" || z && typeof z == "object" && u.call(z) == d || false
                }
    ...
    13: [
        function(b, c, a) {
            (function() {
                ...
                g.isJson = function(l) {
                    return (!i.isUndefined(l) && !i.isNull(l) && l.constructor === {}.constructor)
                };
            ...
            (function() {
                ...
                g.Tracker = function i(E, r, ag) {
                    var Y = document,
                        ...
                        aO = "",
                        ab, N = Y.title,
                        P = "7z|aac|ar[cj]|as[fx]|avi|bin|csv|deb|dmg|doc|exe|flv|gif|gz|gzip|hqx|jar|jpe?g|js|mp(2|3|4|e?g)|mov(ie)?|ms[ip]|od[bfgpst]|og[gv]|pdf|phps|png|ppt|qtm?|ra[mr]?|rpm|sea|sit|tar|t?bz2?|tgz|torrent|txt|wav|wm[av]|wpd||xls|xml|z|zip",
                        at = [aK],
                        t = [],
                        aj = [],
                        D = [],
                    ...
                    function af() {
                        var a2 = (Y.compatMode && Y.compatMode != "BackCompat") ? Y.documentElement : Y.body;
                        return [a2.scrollLeft || R.pageXOffset, a2.scrollTop || R.pageYOffset]
                    }
                    ...
                    function aU(a4, a3, a2, a6, a5) {
                        f.setCookie(B("id"), a4 + "." + a3 + "." + a2 + "." + a6 + "." + a5, A, aW, w)
                    }
                    ...
                    function aG() {
                        ...
                        if (a5) {
                            ...
                            if (!W) {
                                W = Q((G.userAgent || "") + (G.platform || "") + h.stringify(aP) + a2).slice(0, 16)
                            }
                            a4 = ["1", W, a2, 0, a2, ""]
                        }
                        return a4
                    ...
                    function O(a2) {
                        var bk, a3 = new Date(),
                            ...
                            bm, bd, a6, bg, bi, a8, a7, bj, a5 = 1024,
                            bn, bb, bf = B("id"),
                            ba = B("ses"),
                            bh = aG(),
                            be = U("ses"),
                    ...
                    function aI(a2) {
                        return ("https:" == Y.location.protocol ? "https" : "http") + "://" + a2 + "/i"
                    }
                    ...
                    function L(a7) {
                        var a6, a2, a5 = ["", "webkit", "ms", "moz"],
                            a4;
                        if (!V) {
                            for (a2 = 0; a2 < a5.length; a2++) {
                                a4 = a5[a2];
                                if (Object.prototype.hasOwnProperty.call(Y, aR(a4, "hidden"))) {
                    ...
                    function aE(a7) {
                        var a5, a3, a2;
                        while ((a5 = a7.parentNode) !== null && !m.isUndefined(a5) && ((a3 = a7.tagName.toUpperCase()) !== "A" && a3 !== "AREA")) {
                            a7 = a5
                        }
                        if (!m.isUndefined(a7.href)) {
                            var a8 = a7.hostname || d.getHostName(a7.href),
                                ...
                                a6 = new RegExp("^(javascript|vbscript|jscript|mocha|livescript|ecmascript|mailto):", "i");
                            if (!a6.test(a4)) {
                    ...
                    return {
                        getUserId: function() {
                            ...
                            aD(s.transaction.orderId, s.transaction.affiliation, s.transaction.total, s.transaction.tax, s.transaction.shipping, s.transaction.city, s.transaction.state, s.transaction.country, s.transaction.currency, s.transaction.context);
                            for (var a2 = 0; a2 < s.items.length; a2++) {
                                var a3 = s.items[a2];
                                ad(a3.orderId, a3.sku, a3.name, a3.category, a3.price, a3.quantity, a3.currency, a3.context)
                            }
                            s = aH()
