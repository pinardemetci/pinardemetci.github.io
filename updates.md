...
<tr>
  ...
  <td>Delivered an invited talk at the Ohio State University, <a href="https://tgda.osu.edu/">Topology, Geometry, and Data Analysis Seminar </a>, presenting my doctoral work on developing optimal transport-based algorithms for single-cell multi-modal data integration. Many thanks to <a href="https://scholar.google.com/citations?user=Lzc7hZEAAAAJ&hl=en">Aziz Burak Gulen</a> for the invitation! Aziz is a super approachable, humble, and wickedly smart Ph.D. student working with <a href="https://facundo-memoli.org/">Facundo Mémoli</a>, a giant in the field on whose shoulders we stand. Facundo Mémoli is the mathematician that proposed the Gromov-Wasserstein distance, and was just as approachable and humble discussing OT together. So this was a truly surreal day!</td>
 </tr>
<tr>
...
<tr>
  <td class='col-md-3'>6-7 October 2023</td>
  <td> Feeling incredibly inspired after attending <a href="https://istrail-lab.github.io/sorinfest/">SorinFest!</a>, a celebration held to honor my doctoral co-advisor, <a href="">Sorin Istrail</a>, on his 70th birthday. We celebrated his legacy as a computer scientist, leading the development of the sequencing read assembly algorithms used for <a href="https://en.wikipedia.org/wiki/Human_Genome_Project">the Human Genome Project</a> at <a href="https://en.wikipedia.org/wiki/Celera_Corporation">Celera</a>. Many of the pioneers who made the HGP a success, including <a href="https://en.wikipedia.org/wiki/Michael_Waterman">Michael Waterman</a> and <a href="https://en.wikipedia.org/wiki/Craig_Venter">Craig J. Venter</a>, reflected on the progress made (and the promises yet to be reached) in the ~20 years since its completion. It was surreal to hear them retell the stories of such an ambitious undertaking, with all its struggle, competition, and glory. <br>
I was deeply moved to learn more about Sorin’s journey as an immigrant from Romania, the hardships he overcame, contributions he made across multiple fields, the communities he established for computational biology (e.g. <a href="https://en.wikipedia.org/wiki/Research_in_Computational_Molecular_Biology">the RECOMB conference</a> with <a href="https://en.wikipedia.org/wiki/Pavel_A._Pevzner">Pavel Pevzner</a> and <a href="https://en.wikipedia.org/wiki/Bonnie_Berger">Bonnie Berger</a>), and the difference he's made in others' through his generosity of spirit. It is humbling to be co-advised by such a warm person and a capable scientist. We also enjoyed videos of Sorin being overjoyed by hanging out with <a href="https://en.wikipedia.org/wiki/Paul_Erd%C5%91s">Paul Erdős</a>. I learned that I have an Erdős number of 3, via: Me &rarr; Sorin Istrail &rarr; <a href="https://en.wikipedia.org/wiki/Solomon_Marcus">Solomon Marcus</a> &rarr; Paul Erdős. <br>
