...
<tr>
  ...
  <td> Feeling inspired after the <a href="https://istrail-lab.github.io/sorinfest/">SorinFest!</a>, honoring my doctoral co-advisor, <a href="">Sorin Istrail</a>, on his 70th birthday. We celebrated his legacy as a computer scientist, who led the development of the sequencing read assembly algorithms used for <a href="https://en.wikipedia.org/wiki/Human_Genome_Project">the Human Genome Project</a> (HGP) at <a href="https://en.wikipedia.org/wiki/Celera_Corporation">Celera</a>. Many of the pioneers from HGP, including <a href="https://en.wikipedia.org/wiki/Michael_Waterman">Michael Waterman</a> and <a href="https://en.wikipedia.org/wiki/Craig_Venter">Craig J. Venter</a>, reflected on the progress made and the promises yet to be reached since HGP's completion, and retold stories of the difference Sorin has made. It is humbling to be co-advised by such a warm person and a capable scientist! 
